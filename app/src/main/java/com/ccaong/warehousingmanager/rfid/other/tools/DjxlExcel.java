package com.ccaong.warehousingmanager.rfid.other.tools;
...
public class DjxlExcel {
	...
	public void CreateTestBoxExcelfile_v1(List<String> ltags)
		...
		wcf_table_green.setBackground(Colour.GREEN);// 设置单元格的背景颜色
		wcf_table_green.setAlignment(Alignment.CENTRE);// 设置对齐方式

		WritableCellFormat wcf_table_red = new WritableCellFormat(wf_table);// 单元格定义
		wcf_table_red.setBackground(Colour.RED);// 设置单元格的背景颜色
		wcf_table_red.setAlignment(Alignment.CENTRE);// 设置对齐方式
		// **
		// *使用样式的单元格
		// *
