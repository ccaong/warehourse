...
public class MenuFragment extends BaseFragment<FragmentMenuBinding, MainViewModel> {
    ...
    protected void init() {
        ...
        // TODO: 2022/10/10 没有接口
        mDataBinding.ll2.setOnClickListener(view -> startActivity(new Intent(mActivity, SortWareHouseActivity.class)));

        mDataBinding.ll3.setOnClickListener(view -> startActivity(new Intent(mActivity, InventoryActivity.class)));

        // TODO: 2022/10/10  手动上架
        mDataBinding.ll4.setOnClickListener(view -> startActivity(new Intent(mActivity, PutShelvesActivity.class)));

        // 已完成
        mDataBinding.ll5.setOnClickListener(view -> startActivity(new Intent(mActivity, LowerShelvesActivity.class)));

        // TODO: 2022/10/10 没有文档
        mDataBinding.ll6.setOnClickListener(view -> Toast.makeText(mActivity, "todo", Toast.LENGTH_SHORT).show());

        // TODO: 2022/10/10 没有文档
        mDataBinding.ll7.setOnClickListener(view -> Toast.makeText(mActivity, "todo", Toast.LENGTH_SHORT).show());

        // TODO: 2022/10/10 载具码扫码
